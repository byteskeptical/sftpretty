# -*- coding: utf-8 -*-
#
# sftpretty documentation build configuration file, created by
...
project = u'sftpretty'
copyright = u'2026, byteskeptical'
...
htmlhelp_basename = 'sftprettydoc'
...
texinfo_documents = [
  ('index', 'sftpretty', u'SFTPretty Documentation',
   u'byteskeptical', 'sftpretty', 'Pretty secure file transfer made easy.',
   'Miscellaneous'),
]
